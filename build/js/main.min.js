...
},{"./modules/add-swiper":2,"./modules/modals/init-modals":3,"./modules/product":5,"./modules/video":6,"./utils/ios-vh-fix":9}],2:[function(require,module,exports){
"use strict";
...
},{"../vendor/swiper-bundle.min":11}],3:[function(require,module,exports){
"use strict";
...
},{"../../utils/focus-lock":7,"../../utils/scroll-lock":10}],5:[function(require,module,exports){
"use strict";
...
var productContent = document.querySelector('.product__content--nojs');
productContent.classList.remove('product__content--nojs');
var productCard = document.querySelectorAll('.product__card--nojs');
...
document.querySelectorAll('.product__btn').forEach(function (btn) {
  return btn.addEventListener('click', function (evt) {
    ...
    document.querySelectorAll('.product__btn').forEach(function (child) {
      return child.classList.remove('product__btn--active');
    });
    document.querySelectorAll('.product__card').forEach(function (child) {
      return child.classList.remove('product__card--active');
    });
...
function setupVideo(video) {
  ...
  var media = video.querySelector('.video__content');
