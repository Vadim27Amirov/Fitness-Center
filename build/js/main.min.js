...
var _addSwiper = require("./modules/add-swiper");
// ---------------------------------

window.addEventListener('DOMContentLoaded', function () {
  var aboutBlock = document.querySelector('.about');
  var textShow = aboutBlock.getElementsByTagName('aside');
  var slideActive = document.querySelectorAll('.swiper-slide-visible');
  ...
  var getTabIndex = function getTabIndex(slide) {
  ...
  window.addEventListener('load', function () {
    (0, _addSwiper.addCoachSwiper)();
    (0, _addSwiper.addFeedbackSwiper)();
    (0, _initModals.initModals)();
    (0, _product.switchProduct)();
  });
});
...
},{"./modules/add-swiper":2,"./modules/modals/init-modals":3,"./modules/product":5,"./utils/ios-vh-fix":8}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addFeedbackSwiper = exports.addCoachSwiper = void 0;
var _swiperBundle = _interopRequireDefault(require("../vendor/swiper-bundle.min"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var coachSwiper = document.querySelector('.coach-swiper');
var feedbackSwiper = document.querySelector('.feedback__swiper');
var addFeedbackSwiper = function addFeedbackSwiper() {
  if (!feedbackSwiper) {
    return;
  }
  var swiper = new _swiperBundle.default(feedbackSwiper, {
    navigation: {
...
exports.addFeedbackSwiper = addFeedbackSwiper;
var addCoachSwiper = function addCoachSwiper() {
  if (!coachSwiper) {
    return;
  }
  var swiper = new _swiperBundle.default(coachSwiper, {
    navigation: {
...
exports.addCoachSwiper = addCoachSwiper;

},{"../vendor/swiper-bundle.min":10}],3:[function(require,module,exports){
"use strict";
...
exports.switchProduct = void 0;
var productBtnBox = document.querySelector('.product__btn-box');
var productBox = document.querySelectorAll('.product__card');
var productBtn = document.querySelectorAll('.product__btn');
var switchProduct = function switchProduct() {
  productBtnBox.addEventListener('click', function (evt) {
    var currentButton = evt.target.dataset.number;
    if (currentButton) {
      productBox.forEach(function (el) {
        return el.classList.remove('is-open');
      });
      var currentList = document.querySelector("[data-tab='".concat(currentButton, "']"));
...
},{"./ios-checker":7}],10:[function(require,module,exports){
"use strict";
